...
- **[PLAYBOT_ARCHITECTURE_RU.md](PLAYBOT_ARCHITECTURE_RU.md)** — Архитектура (Русский)
  - Трёхслойная архитектура (BotCore/BotCommands/BotMain)
...
├── PLAYBOT_ARCHITECTURE_RU.md      (deep-dive: Русский)
...
| **Read in Russian** | [PLAYBOT_ARCHITECTURE_RU.md](PLAYBOT_ARCHITECTURE_RU.md) |
